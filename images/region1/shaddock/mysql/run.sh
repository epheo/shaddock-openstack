...
crudini --set /etc/mysql/my.cnf mysqld bind-address 0.0.0.0
crudini --set /etc/mysql/my.cnf mysqld default-storage-engine innodb
crudini --set /etc/mysql/my.cnf mysqld innodb_file_per_table on
crudini --set /etc/mysql/my.cnf mysqld max_connections 4096    
